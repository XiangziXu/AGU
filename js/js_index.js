...
function func1()
{
	...
	alert("我就放你出去吧");
	alert("出去了记得好好做人");
	alert("不要再来看这种奇奇怪怪的网页");
	alert("再见");
	alert("等一下");
	alert("你觉得我会这么容易放你出去吗");
	alert("开什么玩笑");
	alert("我们再聊聊吧");
	alert("我给你讲个故事吧");
	alert("从前有个山");
...
function func2()
{
	alert("我也不知道该说什么了，给你们拜年又太早，给你们扫墓上香又太绝，祝你们鸡年大吉吧又不文明，干脆给各位买个棺材吧");
	alert("写这条消息的时候是2017年1月19日");
